...
public class BleCharacteristics107dProAdapter extends BaseMultiItemQuickAdapter<BleOtherChar, BaseViewHolder> {
    public BleCharacteristics107dProAdapter(List<BleOtherChar> data) {
        super(data);
