...
public class BleDevice107dProAdapter extends BaseQuickAdapter<BleDevice, BaseViewHolder> {
    public BleDevice107dProAdapter() {
        super(R.layout.item_ble_device107dpro);
    }
