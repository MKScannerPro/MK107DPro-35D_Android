...
import com.moko.mk107dpro.databinding.ActivityFilterRawDataSwitch107dproBinding;
...
public class FilterRawDataSwitch107dProActivity extends BaseActivity<ActivityFilterRawDataSwitch107dproBinding> {
    ...
    @Override
    protected ActivityFilterRawDataSwitch107dproBinding getViewBinding() {
        return ActivityFilterRawDataSwitch107dproBinding.inflate(getLayoutInflater());
    }
    ...
    public void onFilterByIBeacon(View view) {
        ...
        Intent i = new Intent(this, FilterIBeacon107dProActivity.class);
    ...
    public void onFilterByUid(View view) {
        ...
        Intent i = new Intent(this, FilterUID107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startFilterDetail.launch(i);
    }
    ...
    public void onFilterByUrl(View view) {
        ...
        Intent i = new Intent(this, FilterUrl107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startFilterDetail.launch(i);
    }
    ...
    public void onFilterByTlm(View view) {
        ...
        Intent i = new Intent(this, FilterTLM107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startFilterDetail.launch(i);
    }
    ...
    public void onFilterByBXPButton(View view) {
        ...
        Intent i = new Intent(this, FilterBXPButton107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startFilterDetail.launch(i);
    }
    ...
    public void onFilterByBXPTag(View view) {
        ...
        Intent i = new Intent(this, FilterBXPTag107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startFilterDetail.launch(i);
    }
    ...
    public void onFilterByPIRPresence(View view) {
        ...
        Intent i = new Intent(this, FilterPIR107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startFilterDetail.launch(i);
    }
    ...
    public void onFilterByOther(View view) {
        ...
        Intent i = new Intent(this, FilterOther107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startFilterDetail.launch(i);
    }
