...
import com.moko.mk107dpro.databinding.ActivityMeteringSettings107dproBinding;
 ...
 * @des:
 */
public class MeteringSettings107dProActivity extends BaseActivity<ActivityMeteringSettings107dproBinding> {
    ...
    @Override
    protected ActivityMeteringSettings107dproBinding getViewBinding() {
        return ActivityMeteringSettings107dproBinding.inflate(getLayoutInflater());
    }
