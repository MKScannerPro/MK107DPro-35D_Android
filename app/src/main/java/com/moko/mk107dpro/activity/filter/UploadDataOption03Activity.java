...
import com.moko.mk107dpro.databinding.ActivityUploadDataOptionRemote03Binding;
...
public class UploadDataOption03Activity extends BaseActivity<ActivityUploadDataOptionRemote03Binding> {
    ...
    @Override
    protected ActivityUploadDataOptionRemote03Binding getViewBinding() {
        return ActivityUploadDataOptionRemote03Binding.inflate(getLayoutInflater());
    }
