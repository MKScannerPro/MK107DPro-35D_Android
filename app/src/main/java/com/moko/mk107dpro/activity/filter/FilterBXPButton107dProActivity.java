...
import com.moko.mk107dpro.databinding.ActivityFilterBxpButton107dproBinding;
...
public class FilterBXPButton107dProActivity extends BaseActivity<ActivityFilterBxpButton107dproBinding> {
    ...
    protected void onCreate() {
        ...
        mHandler.postDelayed(() -> {
            ...
            FilterBXPButton107dProActivity.this.finish();
        }, 30 * 1000);
    ...
    @Override
    protected ActivityFilterBxpButton107dproBinding getViewBinding() {
        return ActivityFilterBxpButton107dproBinding.inflate(getLayoutInflater());
    }
