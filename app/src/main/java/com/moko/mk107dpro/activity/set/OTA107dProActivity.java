...
import com.moko.mk107dpro.databinding.ActivityOta107dproBinding;
...
public class OTA107dProActivity extends BaseActivity<ActivityOta107dproBinding> {
    ...
    @Override
    protected ActivityOta107dproBinding getViewBinding() {
        return ActivityOta107dproBinding.inflate(getLayoutInflater());
    }
