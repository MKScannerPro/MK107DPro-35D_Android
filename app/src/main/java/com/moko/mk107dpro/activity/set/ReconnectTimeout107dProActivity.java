...
import com.moko.mk107dpro.databinding.ActivityReconnectTimeout107dproBinding;
...
public class ReconnectTimeout107dProActivity extends BaseActivity<ActivityReconnectTimeout107dproBinding> {
    ...
    @Override
    protected ActivityReconnectTimeout107dproBinding getViewBinding() {
        return ActivityReconnectTimeout107dproBinding.inflate(getLayoutInflater());
    }
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants03.READ_MSG_ID_RECONNECT_TIMEOUT) {
        ...
        if (msg_id == MQTTConstants03.CONFIG_MSG_ID_RECONNECT_TIMEOUT) {
    ...
    private void setReconnectTimeout(int interval) {
        int msgId = MQTTConstants03.CONFIG_MSG_ID_RECONNECT_TIMEOUT;
    ...
    private void getReconnectTimeout() {
        int msgId = MQTTConstants03.READ_MSG_ID_RECONNECT_TIMEOUT;
