...
import com.moko.mk107dpro.databinding.ActivityFilterUid107dproBinding;
...
public class FilterUID107dProActivity extends BaseActivity<ActivityFilterUid107dproBinding> {
    ...
    @Override
    protected ActivityFilterUid107dproBinding getViewBinding() {
        return ActivityFilterUid107dproBinding.inflate(getLayoutInflater());
    }
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants03.READ_MSG_ID_FILTER_UID) {
        ...
        if (msg_id == MQTTConstants03.CONFIG_MSG_ID_FILTER_UID) {
    ...
    private void getFilterUid() {
        int msgId = MQTTConstants03.READ_MSG_ID_FILTER_UID;
    ...
    private void saveParams() {
        int msgId = MQTTConstants03.CONFIG_MSG_ID_FILTER_UID;
