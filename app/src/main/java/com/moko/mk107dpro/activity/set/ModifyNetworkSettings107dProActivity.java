...
public class ModifyNetworkSettings107dProActivity extends BaseActivity<ActivityNetworkSettings107dproBinding> {
    ...
    @Override
    protected ActivityNetworkSettings107dproBinding getViewBinding() {
        return ActivityNetworkSettings107dproBinding.inflate(getLayoutInflater());
    }
