...
public class FilterPIR107dProActivity extends BaseActivity<ActivityFilterPir107dproBinding> {
    ...
    @Override
    protected ActivityFilterPir107dproBinding getViewBinding() {
        return ActivityFilterPir107dproBinding.inflate(getLayoutInflater());
    }
