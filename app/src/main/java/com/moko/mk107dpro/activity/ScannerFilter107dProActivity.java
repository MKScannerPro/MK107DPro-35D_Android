...
import com.moko.mk107dpro.databinding.ActivityScannerFilter107dproBinding;
...
public class ScannerFilter107dProActivity extends BaseActivity<ActivityScannerFilter107dproBinding> implements SeekBar.OnSeekBarChangeListener {
    ...
    @Override
    protected ActivityScannerFilter107dproBinding getViewBinding() {
        return ActivityScannerFilter107dproBinding.inflate(getLayoutInflater());
    }
