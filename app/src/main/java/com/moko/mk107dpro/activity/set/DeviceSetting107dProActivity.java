...
import com.moko.mk107dpro.databinding.ActivityDeviceSetting107dproBinding;
...
public class DeviceSetting107dProActivity extends BaseActivity<ActivityDeviceSetting107dproBinding> {
    private final String FILTER_ASCII = "[ -~]*";
    public static String TAG = DeviceSetting107dProActivity.class.getSimpleName();
    ...
    @Override
    protected ActivityDeviceSetting107dproBinding getViewBinding() {
        return ActivityDeviceSetting107dproBinding.inflate(getLayoutInflater());
    }
                ...
                .setNegativeButton(R.string.save, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (TextUtils.isEmpty(name)) {
                            ToastUtils.showToast(DeviceSetting107dProActivity.this, R.string.more_modify_name_tips);
                            return;
                        }
                        mMokoDevice.name = name;
                        DBTools107dPro.getInstance(DeviceSetting107dProActivity.this).updateDevice(mMokoDevice);
    ...
    public void onSystemTime(View view) {
        ...
        Intent i = new Intent(this, SystemTime107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onModifyMqttSettings(View view) {
        ...
        Intent i = new Intent(this, ModifySettings107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
