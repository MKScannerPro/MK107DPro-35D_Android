...
import com.moko.mk107dpro.databinding.ActivityCommunicationTimeout107dproBinding;
...
public class CommunicationTimeout107dProActivity extends BaseActivity<ActivityCommunicationTimeout107dproBinding> {
    ...
    @Override
    protected ActivityCommunicationTimeout107dproBinding getViewBinding() {
        return ActivityCommunicationTimeout107dproBinding.inflate(getLayoutInflater());
    }
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants03.READ_MSG_ID_COMMUNICATION_TIMEOUT) {
        ...
        if (msg_id == MQTTConstants03.CONFIG_MSG_ID_COMMUNICATION_TIMEOUT) {
    ...
    private void setCommunicationTimeout(int timeout) {
        int msgId = MQTTConstants03.CONFIG_MSG_ID_COMMUNICATION_TIMEOUT;
    ...
    private void getCommunicationTimeout() {
        int msgId = MQTTConstants03.READ_MSG_ID_COMMUNICATION_TIMEOUT;
