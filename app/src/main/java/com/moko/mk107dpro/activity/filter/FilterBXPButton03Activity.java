...
import com.moko.mk107dpro.databinding.ActivityFilterBxpButton03Binding;
...
public class FilterBXPButton03Activity extends BaseActivity<ActivityFilterBxpButton03Binding> {
    ...
    protected void onCreate() {
        ...
        mHandler.postDelayed(() -> {
            ...
            FilterBXPButton03Activity.this.finish();
        }, 30 * 1000);
    ...
    @Override
    protected ActivityFilterBxpButton03Binding getViewBinding() {
        return ActivityFilterBxpButton03Binding.inflate(getLayoutInflater());
    }
