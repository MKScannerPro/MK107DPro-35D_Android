...
public class NtpSettings107dProActivity extends BaseActivity<ActivityNtpSettings107dproBinding> {
    ...
    @Override
    protected ActivityNtpSettings107dproBinding getViewBinding() {
        return ActivityNtpSettings107dproBinding.inflate(getLayoutInflater());
    }
