...
import com.moko.mk107dpro.activity.filter.FilterAdvName107dProActivity;
import com.moko.mk107dpro.activity.filter.FilterMacAddress107dProActivity;
import com.moko.mk107dpro.activity.filter.FilterRawDataSwitch107dProActivity;
...
public class ScannerUploadOption107dProActivity extends BaseActivity<ActivityScannerUploadOption107dproBinding> implements SeekBar.OnSeekBarChangeListener {
    ...
    @Override
    protected ActivityScannerUploadOption107dproBinding getViewBinding() {
        return ActivityScannerUploadOption107dproBinding.inflate(getLayoutInflater());
    }
    ...
    public void onDuplicateDataFilter(View view) {
        ...
        Intent i = new Intent(this, DuplicateDataFilter107dProActivity.class);
    ...
    public void onUploadDataOption(View view) {
        ...
        Intent i = new Intent(this, UploadDataOption107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onFilterByMac(View view) {
        ...
        Intent i = new Intent(this, FilterMacAddress107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onFilterByName(View view) {
        ...
        Intent i = new Intent(this, FilterAdvName107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
    ...
    public void onFilterByRawData(View view) {
        ...
        Intent i = new Intent(this, FilterRawDataSwitch107dProActivity.class);
        i.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
        startActivity(i);
    }
