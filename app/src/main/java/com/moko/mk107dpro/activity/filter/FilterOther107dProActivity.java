...
import com.moko.mk107dpro.databinding.ActivityFilterOther107dproBinding;
...
public class FilterOther107dProActivity extends BaseActivity<ActivityFilterOther107dproBinding> {
    ...
    @Override
    protected ActivityFilterOther107dproBinding getViewBinding() {
        return ActivityFilterOther107dproBinding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_OTHER) {
            ...
            if (number > 0) {
                ...
                for (JsonElement jsonElement : ruleList) {
                    ...
                    View v = LayoutInflater.from(FilterOther107dProActivity.this).inflate(R.layout.item_other_filter_remote, mBind.llFilterCondition, false);
