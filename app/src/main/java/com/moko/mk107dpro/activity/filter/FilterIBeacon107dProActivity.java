...
import com.moko.mk107dpro.databinding.ActivityFilterIbeacon107dproBinding;
...
public class FilterIBeacon107dProActivity extends BaseActivity<ActivityFilterIbeacon107dproBinding> {
    ...
    @Override
    protected ActivityFilterIbeacon107dproBinding getViewBinding() {
        return ActivityFilterIbeacon107dproBinding.inflate(getLayoutInflater());
    }
