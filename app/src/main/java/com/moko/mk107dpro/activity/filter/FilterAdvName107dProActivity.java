...
import com.moko.mk107dpro.databinding.ActivityFilterAdvName107dproBinding;
...
public class FilterAdvName107dProActivity extends BaseActivity<ActivityFilterAdvName107dproBinding> {
    ...
    @Override
    protected ActivityFilterAdvName107dproBinding getViewBinding() {
        return ActivityFilterAdvName107dproBinding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants03.READ_MSG_ID_FILTER_ADV_NAME) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : macList) {
                    ...
                    View v = LayoutInflater.from(FilterAdvName107dProActivity.this).inflate(R.layout.item_adv_name_filter, mBind.llDavName, false);
