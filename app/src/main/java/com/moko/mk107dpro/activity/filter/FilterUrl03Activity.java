...
import com.moko.mk107dpro.databinding.ActivityFilterUrl03Binding;
...
public class FilterUrl03Activity extends BaseActivity<ActivityFilterUrl03Binding> {
    ...
    @Override
    protected ActivityFilterUrl03Binding getViewBinding() {
        return ActivityFilterUrl03Binding.inflate(getLayoutInflater());
    }
