...
import com.moko.mk107dpro.databinding.ActivityIndicatorSetting107dproBinding;
...
public class IndicatorSetting107dProActivity extends BaseActivity<ActivityIndicatorSetting107dproBinding> {
    ...
    protected void onCreate() {
        ...
        mHandler.postDelayed(() -> {
            ...
            IndicatorSetting107dProActivity.this.finish();
        }, 30 * 1000);
    ...
    @Override
    protected ActivityIndicatorSetting107dproBinding getViewBinding() {
        return ActivityIndicatorSetting107dproBinding.inflate(getLayoutInflater());
    }
