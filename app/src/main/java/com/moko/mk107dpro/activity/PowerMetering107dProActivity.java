...
import com.moko.mk107dpro.databinding.ActivityPowerMetering107dproBinding;
 ...
 * @des:
 */
public class PowerMetering107dProActivity extends BaseActivity<ActivityPowerMetering107dproBinding> {
    ...
    @Override
    protected ActivityPowerMetering107dproBinding getViewBinding() {
        return ActivityPowerMetering107dproBinding.inflate(getLayoutInflater());
    }
    ...
    protected void onCreate() {
        ...
        mBind.layoutMeteringSwitch.setOnClickListener(v -> {
            ...
            Intent i = new Intent(this, MeteringSettings107dProActivity.class);
