...
import com.moko.mk107dpro.databinding.ActivityBeaconDfu107dproBinding;
...
public class BeaconDFU107dProActivity extends BaseActivity<ActivityBeaconDfu107dproBinding> {
    ...
    @Override
    protected ActivityBeaconDfu107dproBinding getViewBinding() {
        return ActivityBeaconDfu107dproBinding.inflate(getLayoutInflater());
    }
