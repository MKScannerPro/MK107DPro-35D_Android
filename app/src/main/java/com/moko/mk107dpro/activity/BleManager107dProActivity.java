...
import com.moko.mk107dpro.dialog.PasswordRemoteBleDialog;
import com.moko.mk107dpro.dialog.ScanFilterDialog;
...
public class BleManager107dProActivity extends BaseActivity<ActivityBleDevice107dproBinding> implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    private BleDevice107dProAdapter mAdapter;
    ...
    protected void onCreate() {
        ...
        mAdapter = new BleDevice107dProAdapter();
    ...
    @Override
    protected ActivityBleDevice107dproBinding getViewBinding() {
        return ActivityBleDevice107dproBinding.inflate(getLayoutInflater());
    }
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants.NOTIFY_MSG_ID_BLE_BXP_BUTTON_CONNECT_RESULT) {
            runOnUiThread(() -> {
                ...
                Intent intent = new Intent(this, BXPButtonInfo107dProActivity.class);
        ...
        if (msg_id == MQTTConstants.NOTIFY_MSG_ID_BLE_OTHER_CONNECT_RESULT) {
            runOnUiThread(() -> {
                ...
                Intent intent = new Intent(this, BleOtherInfo107dProActivity.class);
                intent.putExtra(AppConstants.EXTRA_KEY_DEVICE, mMokoDevice);
    ...
    public void onDeviceModifyNameEvent(DeviceModifyNameEvent event) {
        // 修改了设备名称
        MokoDevice device = DBTools107dPro.getInstance(BleManager107dProActivity.this).selectDevice(mMokoDevice.mac);
    ...
    public void onFilter(View view) {
        ...
        scanFilterDialog.setOnScanFilterListener((filterName, filterMac, filterRssi) -> {
            BleManager107dProActivity.this.filterName = filterName;
            BleManager107dProActivity.this.filterMac = filterMac;
            BleManager107dProActivity.this.filterRssi = filterRssi;
            if (!TextUtils.isEmpty(filterName)
                    || !TextUtils.isEmpty(filterMac)
                    || filterRssi != -127) {
        ...
        if (bleDevice.type_code == 7) {
            ...
            dialog.setOnPasswordClicked(password -> {
                ...
                mHandler.postDelayed(() -> {
                    dismissLoadingProgressDialog();
                    ToastUtils.showToast(BleManager107dProActivity.this, "Setup failed");
                }, 50 * 1000);
