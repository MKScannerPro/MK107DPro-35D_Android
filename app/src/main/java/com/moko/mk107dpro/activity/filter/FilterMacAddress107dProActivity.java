...
import com.moko.mk107dpro.databinding.ActivityFilterMacAddress107dproBinding;
...
public class FilterMacAddress107dProActivity extends BaseActivity<ActivityFilterMacAddress107dproBinding> {
    ...
    @Override
    protected ActivityFilterMacAddress107dproBinding getViewBinding() {
        return ActivityFilterMacAddress107dproBinding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_MAC_ADDRESS) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : macList) {
                    ...
                    View v = LayoutInflater.from(FilterMacAddress107dProActivity.this).inflate(R.layout.item_mac_address_filter, mBind.llMacAddress, false);
