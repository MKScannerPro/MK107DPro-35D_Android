...
import com.moko.mk107dpro.databinding.ActivityFilterUid03Binding;
...
public class FilterUID03Activity extends BaseActivity<ActivityFilterUid03Binding> {
    ...
    @Override
    protected ActivityFilterUid03Binding getViewBinding() {
        return ActivityFilterUid03Binding.inflate(getLayoutInflater());
    }
