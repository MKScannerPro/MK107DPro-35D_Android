...
import com.moko.mk107dpro.databinding.ActivityUploadDataOption107dproBinding;
...
public class UploadDataOption107dProActivity extends BaseActivity<ActivityUploadDataOption107dproBinding> {
    ...
    @Override
    protected ActivityUploadDataOption107dproBinding getViewBinding() {
        return ActivityUploadDataOption107dproBinding.inflate(getLayoutInflater());
    }
