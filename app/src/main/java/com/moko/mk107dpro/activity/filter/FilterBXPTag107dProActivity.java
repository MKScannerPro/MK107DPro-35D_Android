...
import com.moko.mk107dpro.databinding.ActivityFilterBxpTag107dproBinding;
...
public class FilterBXPTag107dProActivity extends BaseActivity<ActivityFilterBxpTag107dproBinding> {
    ...
    @Override
    protected ActivityFilterBxpTag107dproBinding getViewBinding() {
        return ActivityFilterBxpTag107dproBinding.inflate(getLayoutInflater());
    }
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_FILTER_BXP_TAG) {
            ...
            if (number != 0) {
                ...
                for (JsonElement jsonElement : tagList) {
                    ...
                    View v = LayoutInflater.from(FilterBXPTag107dProActivity.this).inflate(R.layout.item_mac_address_filter, mBind.llTagId, false);
