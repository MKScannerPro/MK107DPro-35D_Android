...
import com.moko.mk107dpro.dialog.CharWriteDialog;
...
public class BleOtherInfo107dProActivity extends BaseActivity<ActivityOtherInfo107dproBinding> implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    private BleCharacteristics107dProAdapter mAdapter;
    ...
    protected void onCreate() {
        ...
        mAdapter = new BleCharacteristics107dProAdapter(mBleOtherChars);
    ...
    @Override
    protected ActivityOtherInfo107dproBinding getViewBinding() {
        return ActivityOtherInfo107dproBinding.inflate(getLayoutInflater());
    }
    ...
    public void onDeviceModifyNameEvent(DeviceModifyNameEvent event) {
        // 修改了设备名称
        MokoDevice device = DBTools107dPro.getInstance(BleOtherInfo107dProActivity.this).selectDevice(mMokoDevice.mac);
    ...
    public void onDisconnect(View view) {
        ...
        dialog.setOnAlertConfirmListener(() -> {
            ...
            mHandler.postDelayed(() -> {
                dismissLoadingProgressDialog();
                ToastUtils.showToast(BleOtherInfo107dProActivity.this, "Setup failed");
            }, 30 * 1000);
