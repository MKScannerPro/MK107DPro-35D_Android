...
import com.moko.support.mk107dpro35d.entity.BleConnectedList;
...
public class DeviceDetail107dProActivity extends BaseActivity<ActivityDetail107dproBinding> {
    ...
    protected void onCreate() {
        ...
        mAdapter = new ScanDevice107dProAdapter();
    ...
    @Override
    protected ActivityDetail107dproBinding getViewBinding() {
        return ActivityDetail107dproBinding.inflate(getLayoutInflater());
    }
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants.READ_MSG_ID_BLE_CONNECTED_LIST) {
            ...
            if (result.data.ble_conn_list != null && !result.data.ble_conn_list.isEmpty()) {
                ...
                Intent intent = new Intent(this, BleManager107dProActivity.class);
    ...
    public void onDeviceModifyNameEvent(DeviceModifyNameEvent event) {
        // 修改了设备名称
        MokoDevice device = DBTools107dPro.getInstance(DeviceDetail107dProActivity.this).selectDevice(mMokoDevice.mac);
    ...
    public void onScannerOptionSetting(View view) {
        ...
        Intent i = new Intent(this, ScannerUploadOption107dProActivity.class);
