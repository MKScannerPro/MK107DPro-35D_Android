...
import com.moko.mk107dpro.databinding.ActivitySyncFromNtp107dproBinding;
...
public class SyncTimeFromNTP107dProActivity extends BaseActivity<ActivitySyncFromNtp107dproBinding> {
    ...
    @Override
    protected ActivitySyncFromNtp107dproBinding getViewBinding() {
        return ActivitySyncFromNtp107dproBinding.inflate(getLayoutInflater());
    }
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants03.READ_MSG_ID_NTP_SERVER) {
        ...
        if (msg_id == MQTTConstants03.CONFIG_MSG_ID_NTP_SERVER) {
    ...
    private void getNtpServer() {
        int msgId = MQTTConstants03.READ_MSG_ID_NTP_SERVER;
    ...
    private void setNtpServer() {
        int msgId = MQTTConstants03.CONFIG_MSG_ID_NTP_SERVER;
