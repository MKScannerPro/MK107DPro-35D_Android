...
import com.moko.mk107dpro.databinding.ActivityFilterUrl107dproBinding;
...
public class FilterUrl107dProActivity extends BaseActivity<ActivityFilterUrl107dproBinding> {
    ...
    @Override
    protected ActivityFilterUrl107dproBinding getViewBinding() {
        return ActivityFilterUrl107dproBinding.inflate(getLayoutInflater());
    }
    ...
    public void onMQTTMessageArrivedEvent(MQTTMessageArrivedEvent event) {
        ...
        if (msg_id == MQTTConstants03.READ_MSG_ID_FILTER_URL) {
        ...
        if (msg_id == MQTTConstants03.CONFIG_MSG_ID_FILTER_URL) {
    ...
    private void getFilterUrl() {
        int msgId = MQTTConstants03.READ_MSG_ID_FILTER_URL;
    ...
    private void saveParams() {
        int msgId = MQTTConstants03.CONFIG_MSG_ID_FILTER_URL;
