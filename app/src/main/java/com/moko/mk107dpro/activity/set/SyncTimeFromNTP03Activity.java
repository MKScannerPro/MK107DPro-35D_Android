...
import com.moko.mk107dpro.databinding.ActivitySyncFromNtp03Binding;
...
public class SyncTimeFromNTP03Activity extends BaseActivity<ActivitySyncFromNtp03Binding> {
    ...
    @Override
    protected ActivitySyncFromNtp03Binding getViewBinding() {
        return ActivitySyncFromNtp03Binding.inflate(getLayoutInflater());
    }
