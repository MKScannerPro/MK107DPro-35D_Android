...
import com.moko.mk107dpro.databinding.ActivityReconnectTimeout03Binding;
...
public class ReconnectTimeout03Activity extends BaseActivity<ActivityReconnectTimeout03Binding> {
    ...
    @Override
    protected ActivityReconnectTimeout03Binding getViewBinding() {
        return ActivityReconnectTimeout03Binding.inflate(getLayoutInflater());
    }
