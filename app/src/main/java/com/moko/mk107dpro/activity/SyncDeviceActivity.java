...
import com.moko.mk107dpro.adapter.SyncDeviceAdapter;
import com.moko.mk107dpro.base.BaseActivity;
import com.moko.mk107dpro.databinding.ActivityDevicesBinding;
import com.moko.mk107dpro.db.DBTools107dPro;
import com.moko.mk107dpro.dialog.LogoutDialog;
...
import com.moko.mk107dpro.net.entity.SyncDevice;
...
public class SyncDeviceActivity extends BaseActivity<ActivityDevicesBinding> implements BaseQuickAdapter.OnItemClickListener {
    ...
    private void syncDevices(List<SyncDevice> syncDevices) {
        ...
        OkGo.<String>post(Urls.syncGatewayApi(getApplicationContext()))
                .upRequestBody(body)
                .headers("Authorization", Main107dProActivity.mAccessToken)
