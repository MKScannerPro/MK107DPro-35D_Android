 ...
 * @des:
 */
public class AdvertiseIBeacon107dProActivity extends BaseActivity<ActivityAdvertiseIbeacon107dproBinding> {
    ...
    @Override
    protected ActivityAdvertiseIbeacon107dproBinding getViewBinding() {
        return ActivityAdvertiseIbeacon107dproBinding.inflate(getLayoutInflater());
    }
