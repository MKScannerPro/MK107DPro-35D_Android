...
import com.moko.mk107dpro.activity.set.ModifySettings107dProActivity;
import com.moko.mk107dpro.adapter.Device107dProAdapter;
...
public class Main107dProActivity extends BaseActivity<ActivityMain10dproBinding> implements BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.OnItemLongClickListener {
    private ArrayList<MokoDevice> devices;
    private Device107dProAdapter adapter;
    ...
    protected void onCreate() {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                PATH_LOGCAT = getExternalFilesDir(null).getAbsolutePath() + File.separator + (BuildConfig.IS_LIBRARY ? "MKScannerPro" : "MK107DPro35D");
            } else {
                PATH_LOGCAT = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + (BuildConfig.IS_LIBRARY ? "MKScannerPro" : "MK107DPro35D");
            }
        } else {
        ...
        adapter = new Device107dProAdapter();
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                startActivityForResult(new Intent(this, SetAppMQTT107dProActivity.class), AppConstants.REQUEST_CODE_MQTT_CONFIG_APP);
            }
            // 读取stacktrace信息
    ...
    @Override
    protected ActivityMain10dproBinding getViewBinding() {
        return ActivityMain10dproBinding.inflate(getLayoutInflater());
    }
        ...
        if (!devices.isEmpty()) {
            for (MokoDevice device : devices) {
                if (device.mac.equals(event.getMac())) {
                    device.name = DBTools107dPro.getInstance(this).selectDevice(device.mac).name;
                    break;
                }
            }
        }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (getIntent().getExtras() != null) {
            ...
            if (ModifyName107dProActivity.TAG.equals(from)
                    || DeviceSetting107dProActivity.TAG.equals(from)) {
                devices.clear();
                devices.addAll(DBTools107dPro.getInstance(this).selectAllDevice());
            ...
            if (ModifySettings107dProActivity.TAG.equals(from)) {
                if (!TextUtils.isEmpty(mac)) {
                    MokoDevice mokoDevice = DBTools107dPro.getInstance(this).selectDevice(mac);
                    for (final MokoDevice device : devices) {
                        if (mac.equals(device.mac)) {
    ...
    public void mainAddDevices(View view) {
        ...
        if (Utils.isNetworkAvailable(this)) {
            ...
            startActivity(new Intent(this, DeviceScanner107dProActivity.class));
        } else {
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if (commonResp.code != 200) {
                            com.moko.lib.scannerui.utils.ToastUtils.showToast(Main107dProActivity.this, commonResp.msg);
                            LoginDialog dialog = new LoginDialog();
                        ...
                        IoTDMSPUtils.setStringValue(Main107dProActivity.this, IoTDMConstants.EXTRA_KEY_LOGIN_ACCOUNT, account);
                        IoTDMSPUtils.setStringValue(Main107dProActivity.this, IoTDMConstants.EXTRA_KEY_LOGIN_PASSWORD, password);
                        IoTDMSPUtils.setIntValue(Main107dProActivity.this, IoTDMConstants.EXTRA_KEY_LOGIN_ENV, envValue);
                        Intent intent = new Intent(Main107dProActivity.this, SyncDeviceActivity.class);
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        Intent i = new Intent(Main107dProActivity.this, DeviceDetail107dProActivity.class);
    ...
    public boolean onItemLongClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        dialog.setOnAlertConfirmListener(() -> {
            if (!MQTTSupport.getInstance().isConnected()) {
                ToastUtils.showToast(Main107dProActivity.this, R.string.network_error);
                return;
            }
            showLoadingProgressDialog();
            // 取消订阅
            ...
            DBTools107dPro.getInstance(Main107dProActivity.this).deleteDevice(mokoDevice);
