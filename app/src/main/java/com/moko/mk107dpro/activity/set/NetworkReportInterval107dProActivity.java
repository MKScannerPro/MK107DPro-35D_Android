...
import com.moko.mk107dpro.databinding.ActivityNetworkReportInterval107dproBinding;
...
public class NetworkReportInterval107dProActivity extends BaseActivity<ActivityNetworkReportInterval107dproBinding> {
    ...
    @Override
    protected ActivityNetworkReportInterval107dproBinding getViewBinding() {
        return ActivityNetworkReportInterval107dproBinding.inflate(getLayoutInflater());
    }
