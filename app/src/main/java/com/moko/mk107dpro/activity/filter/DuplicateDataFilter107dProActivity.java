...
import com.moko.mk107dpro.databinding.ActivityDuplicateDataFilter107dproBinding;
...
public class DuplicateDataFilter107dProActivity extends BaseActivity<ActivityDuplicateDataFilter107dproBinding> {
    ...
    @Override
    protected ActivityDuplicateDataFilter107dproBinding getViewBinding() {
        return ActivityDuplicateDataFilter107dproBinding.inflate(getLayoutInflater());
    }
