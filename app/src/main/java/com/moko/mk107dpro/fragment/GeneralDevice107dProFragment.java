...
public class GeneralDevice107dProFragment extends Fragment {
    ...
    private FragmentGeneralDevice107dproBinding mBind;
    private boolean cleanSession;
    private int qos;
    private int keepAlive;

    public GeneralDevice107dProFragment() {
    }

    public static GeneralDevice107dProFragment newInstance() {
        return new GeneralDevice107dProFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mBind = FragmentGeneralDevice107dproBinding.inflate(inflater, container, false);
