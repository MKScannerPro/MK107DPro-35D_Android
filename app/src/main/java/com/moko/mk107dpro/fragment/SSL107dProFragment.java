...
public class SSL107dProFragment extends Fragment {
    ...
    private static final String TAG = SSL107dProFragment.class.getSimpleName();
    private FragmentSslApp107dproBinding mBind;
    ...
    public SSL107dProFragment() {
    }

    public static SSL107dProFragment newInstance() {
        return new SSL107dProFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mBind = FragmentSslApp107dproBinding.inflate(inflater, container, false);
