...
public class SSLDeviceUrl107dProFragment extends Fragment {

    private static final String TAG = SSLDeviceUrl107dProFragment.class.getSimpleName();
    private FragmentSslDeviceUrl107dproBinding mBind;
    private ModifyMQTTSettings107dProActivity activity;
    ...
    public SSLDeviceUrl107dProFragment() {
    }

    public static SSLDeviceUrl107dProFragment newInstance() {
        return new SSLDeviceUrl107dProFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mBind = FragmentSslDeviceUrl107dproBinding.inflate(inflater, container, false);
        activity = (ModifyMQTTSettings107dProActivity) getActivity();
