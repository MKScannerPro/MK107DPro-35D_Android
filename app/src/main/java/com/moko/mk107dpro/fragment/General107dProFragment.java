...
import com.moko.mk107dpro.databinding.FragmentGeneralApp107dproBinding;
import com.moko.mk107dpro.utils.ToastUtils;

public class General107dProFragment extends Fragment {

    private static final String TAG = General107dProFragment.class.getSimpleName();
    private FragmentGeneralApp107dproBinding mBind;
    private boolean cleanSession;
    private int qos;
    private int keepAlive;

    public General107dProFragment() {
    }

    public static General107dProFragment newInstance() {
        return new General107dProFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mBind = FragmentGeneralApp107dproBinding.inflate(inflater, container, false);
