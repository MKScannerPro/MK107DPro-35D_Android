...
public class SSLDevice107dProFragment extends Fragment {
    ...
    private static final String TAG = SSLDevice107dProFragment.class.getSimpleName();
    private FragmentSslDevice107dproBinding mBind;
    ...
    public SSLDevice107dProFragment() {
    }

    public static SSLDevice107dProFragment newInstance() {
        return new SSLDevice107dProFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mBind = FragmentSslDevice107dproBinding.inflate(inflater, container, false);
