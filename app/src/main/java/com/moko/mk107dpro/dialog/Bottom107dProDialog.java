package com.moko.mk107dpro.dialog;

import android.text.TextUtils;
import android.view.LayoutInflater;
import android.view.ViewGroup;

import com.moko.mk107dpro.databinding.DialogBottom107dproBinding;

import java.util.ArrayList;

public class Bottom107dProDialog extends MokoBaseDialog<DialogBottom107dproBinding> {
    private ArrayList<String> mDatas;
    private int mIndex;

    @Override
    protected DialogBottom107dproBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return DialogBottom107dproBinding.inflate(inflater, container, false);
    }
